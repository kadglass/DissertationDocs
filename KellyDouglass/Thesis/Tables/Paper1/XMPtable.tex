...
\begin{tabu} to 0.75\linewidth {ccccccc}
Index\footnote[1]{KIAS-VAGC galaxy index number} & R.A. & Decl. & Redshift & \multicolumn{2}{c}{$12 + \log \left( \frac{\text{O}}{\text{H}} \right)$} & Void/Wall \\
\hline \\
