...
$12 + \log (\text{O}/\text{H}) \gtrsim 8.5$, [\ion{O}{3}] $\lambda$4363 becomes 
...
\begin{deluxetable}{L|C|C|C}
    \tablewidth{0pt}
    \tablecaption{Coefficients of oxygen abundance fits\label{tab:ab}}
    \tablehead{\colhead{} & \colhead{SF (dwarf)} & \colhead{SF ($M_r > -20$)} & \colhead{AGN \& Composite}}
    \startdata
        a & 0.84 \pm 0.013 & 0.824 \pm 0.0010 & 0.764 \pm 0.0035\\
        b & 1.61 \pm 0.094 & 1.787 \pm 0.0065 & 2.05 \pm 0.023\\
    \enddata
    \tablecomments{Coefficients for the linear trends (Eqn. \ref{eq:fit}) fit to 
    the SF galaxies (dwarf and those with $M_r > -20$) and AGN and composite 
    galaxies.  With these trends, we can now calculate the total oxygen 
    abundance for a galaxy with knowing only the O$^{++}$/H abundance.}
\end{deluxetable}
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{SDSS data and galaxy selection}
...
% Re-write to avoid plagarizing myself :P
...
%evolution.  As discussed in Section \ref{sec:Theory}, the strength of and 
...
The selection criteria outlined in Section \ref{sec:SDSS_limits} limit our 
...
\begin{figure*}
    \centering
    \includegraphics[width=0.49\textwidth]{1sig_dwarf_SF_t3_12logOHrelations_dust_hist}
    \includegraphics[width=0.49\textwidth]{1sig_dwarf_SF_t3_12logOHrelations_dust_CDF}
...
\begin{figure*}
    \centering
    \includegraphics[width=0.49\textwidth]{1sig_dwarf_SF_t3_12logNHrelations_dust_hist}
    \includegraphics[width=0.49\textwidth]{1sig_dwarf_SF_t3_12logNHrelations_dust_CDF}
...
\begin{figure*}
    \centering
    \includegraphics[width=0.49\textwidth]{1sig_dwarf_SF_t3_logNOrelations_dust_hist}
    \includegraphics[width=0.49\textwidth]{1sig_dwarf_SF_t3_logNOrelations_dust_CDF}
...
\begin{deluxetable}{ccccccc}
    \tablewidth{0pt}
    \tablecolumns{7}
    \tablecaption{Abundance statistics\label{tab:stats}}
    \tablehead{\colhead{Environment} & \colhead{Average} & \colhead{Median} & \colhead{Average Shift\tablenotemark{a}} & \colhead{Median Shift\tablenotemark{a}} & \colhead{$p$-value} & \colhead{K-S Test Statistic}}
    \startdata
        % Oxygen %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        \cutinhead{$12 + \log (\text{O}/\text{H})$}
    ...
    \enddata
    \tablecomments{Statistics on the gas-phase oxygen, nitrogen, and nitrogen 
    relative to oxygen abundances in dwarf void and wall galaxies.  Combined 
    with the histograms in Figures \ref{fig:met1sig}--\ref{fig:NOratio}, these 
    results indicate an influence on the chemical evolution of galaxies by the 
    large-scale environment, especially on the relative abundance of nitrogen to 
    oxygen.  Void galaxies have slightly higher oxygen and nitrogen abundances 
    than wall galaxies, but void galaxies have slightly lower N/O ratios than 
    wall galaxies.}
    \tablenotetext{a}{Wall -- Void (Positive shifts indicate that the wall 
    values are greater than the void values; negative shifts indicate that the 
    void values are greater than the wall values.)}
\end{deluxetable}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{1sig_dwarf_I06relations_SF_t3_T04comparison_dust}
...
\begin{figure}
    \centering
%    \includegraphics[width=0.5\textwidth]{1sig_I06relations_dwarf_SF_t3_dust_Z12logOH_logNO}
%    \includegraphics[width=0.5\textwidth]{1sig_I06relations_dwarf_SF_t3_dust_Z12logOH_logNO_Mbin}
%    \includegraphics[width=0.5\textwidth]{1sig_I06relations_dwarf_SF_t3_dust_Z12logOH_logNO_scatterMbin}
    \includegraphics[width=0.5\textwidth]{1sig_I06relations_dwarf_SF_t3_dust_NSA_Z12logOH_logNO_scatterMbin}
...
\begin{figure}
%    \includegraphics[width=0.5\textwidth]{1sig_I06relations_dwarf_SF_t3_dust_Z12logOH_N12logNH_scatterMbin}
    \includegraphics[width=0.5\textwidth]{1sig_I06relations_dwarf_SF_t3_dust_NSA_Z12logOH_N12logNH_scatterMbin}
    \caption{Oxygen abundance ($12 + \log \left(\text{O}/\text{H}\right)$) 
...
\begin{figure*}
    \centering
%    \includegraphics[width=0.49\textwidth]{MZ_1sig_I06relations_SF_t3_Mbin}
    \includegraphics[width=0.49\textwidth]{MZ_1sig_I06relations_dwarf_SF_t3_dust_NSA_python}
    \includegraphics[width=0.49\textwidth]{MNO_1sig_I06relations_dwarf_SF_t3_dust_NSA_scatterMbin}
%    \includegraphics[width=0.49\textwidth]{MNO_1sig_I06relations_dwarf_SF_t3_dust}
...
\begin{figure*}
    \centering
    \includegraphics[width=0.49\textwidth]{1sig_0-17_I06relations_SF_t3_HI_hist}
    \includegraphics[width=0.49\textwidth]{1sig_0-17_I06relations_SF_t3_HI_CDF}
    \caption{The distribution of \ion{H}{1} mass in the sample of dwarf 
    galaxies, separated by their large-scale environment.  There is an obvious 
    shift towards higher \ion{H}{1} masses in the void dwarf galaxies.}
    \label{fig:HI_hist}
\end{figure*}
...
\begin{figure*}
    \centering
    \includegraphics[width=0.49\textwidth]{HI_OH_1sig_I06relations_dwarf+T04_SF_t3_dust}
    \includegraphics[width=0.49\textwidth]{HI_NO_1sig_I06relations_dwarf_SF_t3_dust}
    \includegraphics[width=0.49\textwidth]{HI_OH_M_1sig_I06relations_dwarf_SF_t3_dust}
    \includegraphics[width=0.49\textwidth]{HI_NO_M_1sig_I06relations_dwarf_SF_t3_dust}
    \caption{\ion{H}{1} mass versus metallicity (left) and N/O ratio (right) for 
    ...
    row investigates the relationship between stellar mass, \ion{H}{1} mass, and 
    ...
    the relationship between the \ion{H}{1} mass and gas-phase chemical 
...
\begin{figure*}
    \centering
%    \includegraphics[width=0.49\textwidth]{ur_OH_1sig_I06relations_dwarf_SF_t3_dust_python}
%    \includegraphics[width=0.49\textwidth]{ur_OH_1sig_I06relations_dwarf_SF_t3_dust}
    \includegraphics[width=0.49\textwidth]{ur_OH_1sig_I06relations_dwarf+T04_SF_t3_dust}
    \includegraphics[width=0.49\textwidth]{ur_NO_1sig_I06relations_dwarf_SF_t3_dust_scatterURbin}
...
\begin{figure*}
    \centering
%    \includegraphics[width=0.49\textwidth]{gr_OH_1sig_I06relations_dwarf_SF_t3_dust_python}
%    \includegraphics[width=0.49\textwidth]{gr_OH_1sig_I06relations_dwarf_SF_t3_dust}
    \includegraphics[width=0.49\textwidth]{gr_OH_1sig_I06relations_dwarf+T04_SF_t3_dust}
    \includegraphics[width=0.49\textwidth]{gr_NO_1sig_I06relations_dwarf_SF_t3_dust_scatterGRbin}
...
\begin{figure*}
    \centering
%    \includegraphics[width=0.49\textwidth]{SFR_OH_1sig_I06relations_dwarf_SF_t3_dust_python}
    \includegraphics[width=0.49\textwidth]{SFR_OH_1sig_I06relations_dwarf+T04_SF_t3_dust}
    \includegraphics[width=0.49\textwidth]{SFR_NO_1sig_I06relations_dwarf_SF_t3_dust_scatterSFRbin}
...
\begin{figure*}
    \centering
%    \includegraphics[width=0.49\textwidth]{sSFR_OH_1sig_I06relations_dwarf_SF_t3_dust_python}
    \includegraphics[width=0.49\textwidth]{sSFR_OH_1sig_I06relations_dwarf+T04_SF_t3_dust}
    \includegraphics[width=0.49\textwidth]{sSFR_NO_1sig_I06relations_dwarf_SF_t3_dust_scattersSFRbin}
...
As we see on the right in Fig. \ref{fig:sSFR}, though, there is a strong 
...
the metallicity and \ion{H}{1} mass of the galaxies, but the N/O ratio decreases 
with increasing \ion{H}{1} mass for fixed stellar mass.  The star-forming dwarf 
