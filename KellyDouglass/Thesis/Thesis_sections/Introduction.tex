...
The first stars that formed are thought to have been composed of only hydrogen 
...
lines.  We study the gas-phase chemical abundances of \ion{H}{2} regions in a 
...
source in an \ion{H}{2} region, so lower metallicities correspond to higher 
