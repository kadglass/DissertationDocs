...
%For visible light, it is safe to assume that the spatial portion of the field 
%does not change, since the wavelength is much longer than the size of the atom.  
